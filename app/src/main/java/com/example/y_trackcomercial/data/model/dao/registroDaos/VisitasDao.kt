...
interface VisitasDao {
    ...
    suspend fun insertVisitas(visita: com.example.y_trackcomercial.data.model.entities.registro_entities.VisitasEntity): Long
...
/** SECTOR DE EXPORTACIONES. */
    ...
    suspend fun getVisitasExportaciones(): List<com.example.y_trackcomercial.data.model.entities.registro_entities.VisitasEntity>
