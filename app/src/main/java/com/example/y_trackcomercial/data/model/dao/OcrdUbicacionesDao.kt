...
interface OcrdUbicacionesDao {
    ...
    fun getOcrdUbicaciones(): LiveData<List<com.example.y_trackcomercial.data.model.entities.OcrdUbicacionEntity>>
    ...
    @Transaction
    suspend fun insertOcrdUbicaciones(ubicaciones: List<com.example.y_trackcomercial.data.model.entities.OcrdUbicacionEntity>)
