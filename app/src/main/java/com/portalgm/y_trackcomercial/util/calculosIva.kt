...
object calculosIva {
    fun calcularPrecioSinIva(priceWithVat: Int): Double {
        return (priceWithVat / 1.05)
    }

    fun calcularTotalSinIva(quantity: Int, priceWithVat: Int): Double {
    ...
    fun calcularIva(quantity: Int, priceWithVat: Int): Double {
