...
interface MovimientosDao {
    @Transaction
    @Insert
    suspend fun insertAllMovimiento(Movimiento: List<com.portalgm.y_trackcomercial.data.model.entities.registro_entities.MovimientosEntity>)
    ...
    suspend fun getInformeMovimiento(fecha: String): MutableList<com.portalgm.y_trackcomercial.data.model.models.InformeInventario>
