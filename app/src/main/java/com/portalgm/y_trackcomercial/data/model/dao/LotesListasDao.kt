...
interface LotesListasDao {
    ...
    fun getLotesListas(): LiveData<List<com.portalgm.y_trackcomercial.data.model.entities.LotesListasEntity>>
    ...
    @Transaction
    suspend fun insertAllLotesListas(customers: List<com.portalgm.y_trackcomercial.data.model.entities.LotesListasEntity>)
