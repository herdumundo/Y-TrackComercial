...
import com.portalgm.y_trackcomercial.components.RoundedButton
...
fun LoginButton(
    ...
    Box(
        ...
        RoundedButton(
            ...
            backgroundColor = if (botonCargar == 4) Color(0xFFf910000) else if (botonCargar == 5) Color(0xFFC77700) else Color(0xFF4B4B4D)
        )
...
fun LoginDivider() {
    Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
        ...
        Text(
            text = "Y TRACK ${BuildConfig.VERSION_NAME}",
