package com.ytrack.y_trackcomercial.repository.registroRepositories.logRepositories
...
import com.ytrack.y_trackcomercial.data.api.request.lotesDeActividades
import javax.inject.Inject

class LogRepository @Inject constructor
    (private val logDao: com.ytrack.y_trackcomercial.data.model.dao.registroDaos.logsDaos.LogDao,
     private val exportacionAuditLogApiClient: ExportacionAuditLogApiClient
    ) {
    suspend fun insertLog(log: com.ytrack.y_trackcomercial.data.model.entities.logs.LogEntity): Long {
