...
import com.ytrack.y_trackcomercial.data.api.exportaciones.ExportacionMovimientosApiClient
...
class MovimientosRepository @Inject constructor
    (
    private val movimientosDao: com.ytrack.y_trackcomercial.data.model.dao.registroDaos.MovimientosDao,
    private val exportacionMovimientosApiClient: ExportacionMovimientosApiClient
) {

    suspend fun insertLotesInBulk(lotesList: List<com.ytrack.y_trackcomercial.data.model.models.Lotes>) {
        //  val createdAtLongVar=System.currentTimeMillis()
        val movimientosList = lotesList.map { lote ->
            com.ytrack.y_trackcomercial.data.model.entities.registro_entities.MovimientosEntity(
    ...
    suspend fun getInformeInventario(fecha: String): MutableList<com.ytrack.y_trackcomercial.data.model.models.InformeInventario> =
