...
class RutasAccesosRepository @Inject constructor(
    private val rutasAccesosDao: com.ytrack.y_trackcomercial.data.model.dao.RutasAccesosDao
    )
{
    ...
    private fun convertToRutasAccesosEntity(rutasAccesos: RutasAccesos): com.ytrack.y_trackcomercial.data.model.entities.RutasAccesosEntity {
        return com.ytrack.y_trackcomercial.data.model.entities.RutasAccesosEntity(
            id = rutasAccesos.id,
