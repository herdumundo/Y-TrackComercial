package com.ytrack.y_trackcomercial.util.registrosVisitas
...
): com.ytrack.y_trackcomercial.data.model.entities.registro_entities.VisitasEntity {
    return com.ytrack.y_trackcomercial.data.model.entities.registro_entities.VisitasEntity(
        id = id,
        idUsuario = idUsuario,
        idOcrd = idOcrd,
