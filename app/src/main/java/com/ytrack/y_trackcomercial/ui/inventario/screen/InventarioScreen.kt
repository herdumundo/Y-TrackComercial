package com.ytrack.y_trackcomercial.ui.inventario.screen
...
import com.ytrack.y_trackcomercial.components.SnackAlerta
...
fun InventarioBody(
    ...
    idLote: String,
    txtCantidad: String,
    lotesList: SnapshotStateList<com.ytrack.y_trackcomercial.data.model.models.Lotes>
) {
...
fun LotesSelectionDialog(
    lotes: List<com.ytrack.y_trackcomercial.data.model.models.LotesItem>,
    onLoteSelected: () -> Unit,
...
fun OitmSelectionDialog(
    oitms: List<com.ytrack.y_trackcomercial.data.model.models.OitmItem>,
    onDismiss: () -> Unit,
    inventarioViewModel: InventarioViewModel,
) {
    var searchText by remember { mutableStateOf("") }
...
fun UbicacionSelectionDialog(
    ubicaciones: List<com.ytrack.y_trackcomercial.data.model.models.UbicacionPv>,
    onDismiss: () -> Unit,
    inventarioViewModel: InventarioViewModel,
) {
    var searchText by remember { mutableStateOf("") }
