package com.ytrack.y_trackcomercial.ui.inventario.viewmodel
...
class InventarioViewModel @Inject constructor(
    ...
    private val _oitmItemList: MutableList<com.ytrack.y_trackcomercial.data.model.models.OitmItem> = mutableListOf()
    private val _ubicacionesList: MutableList<com.ytrack.y_trackcomercial.data.model.models.UbicacionPv> = mutableListOf()
    private val _LoteItemList: MutableList<com.ytrack.y_trackcomercial.data.model.models.LotesItem> = mutableListOf()
    ...
    val lotesList = mutableStateListOf<com.ytrack.y_trackcomercial.data.model.models.Lotes>()
    ...
    fun addLotes() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val newLote = com.ytrack.y_trackcomercial.data.model.models.Lotes(
    ...
    fun getLotes(): List<com.ytrack.y_trackcomercial.data.model.models.LotesItem> {
