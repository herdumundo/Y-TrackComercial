...
import com.ytrack.y_trackcomercial.data.model.entities.HorariosUsuarioEntity
import java.util.*
...
interface HorariosUsuarioDao {
    ...
    fun getHorarioUsuario(): LiveData<List<com.ytrack.y_trackcomercial.data.model.entities.HorariosUsuarioEntity>>
    ...
    fun getHorarioActual(horaActual: String): List<com.ytrack.y_trackcomercial.data.model.entities.HorariosUsuarioEntity>
