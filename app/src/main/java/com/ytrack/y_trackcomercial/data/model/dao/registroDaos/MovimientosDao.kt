package com.ytrack.y_trackcomercial.data.model.dao.registroDaos
...
interface MovimientosDao {
    @Transaction
    @Insert
    suspend fun insertAllMovimiento(Movimiento: List<com.ytrack.y_trackcomercial.data.model.entities.registro_entities.MovimientosEntity>)
    ...
    suspend fun getInformeMovimiento(fecha: String): MutableList<com.ytrack.y_trackcomercial.data.model.models.InformeInventario>
